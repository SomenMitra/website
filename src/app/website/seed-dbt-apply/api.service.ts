...
getSeedInventoryAvailablity(params: any): Observable<any> {
  let serviceUrl = environment.domainUrl + 'integration/getSeedInventoryAvailablity'//environment.serviceURL+'getSeedInventoryAvailablity';
  let serviceRes = this.Http.post(serviceUrl, params);
  return serviceRes;
}

getSubsidyHectare(params: any): Observable<any> {
  let serviceUrl = environment.domainUrl + 'integration/getSubsidyHectare'//environment.serviceURL+'getSubsidyHectare';
  let serviceRes = this.Http.post(serviceUrl, params);
  return serviceRes;
}
