      ...
      if (res.status > 0) {
        ...
        setTimeout(function () { 
          ...
          if(curObj.schemeId == environment.seedDBT){
            ...
            container.innerHTML = '<input type="button" value="Add seed details" name="btnopenSeedDetails" id="btnopenSeedDetails" class="openSeedDetails btn btn-success " data-toggle="modal" data-target="#someSeedDBTModal" (click)="openSeedDetails(1)"> ';
        ...
        $('.seedSchemeType').on('change',function(){
    ...
    this.objProf.getRedirectFarmerAPI(apiParam).subscribe(res => {
      ...
      if (res.status == 1) {
        ...
        if(redirectFrnmName!='')
        {
          ...
          (<HTMLInputElement>document.getElementById(farmer_mobile_id)).value = res.result.resultInfo.res['VCHMOBILENO1'];
          this.schemeForm.patchValue({ [farmer_mobile_id]:  res.result.resultInfo.res['VCHMOBILENO1'] });
