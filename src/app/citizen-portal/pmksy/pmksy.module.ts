...
import { PmksyRoutingModule } from './pmksy-routing.module';
...
@NgModule({
  declarations: [SchemeApplyComponent, UpdateschemestatusComponent, AppliedSchemeDetailsComponent, SchemeDocumentComponent, SchemePreviewComponent, SuccessComponent, ProfileUpdateComponent, SchemeQueryReplyComponent],
  imports: [
    CommonModule,
    HttpClientModule,
	PmksyRoutingModule,
