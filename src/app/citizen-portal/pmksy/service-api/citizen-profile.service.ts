...
export class CitizenProfileService {  
  ...
  getLandArea(params:any):Observable<any>{
    let serviceUrl = environment.serviceURL+'getLandArea';
    let serviceRes = this.Http.post(serviceUrl,params);
    return serviceRes;
  }
  getSubsidydetail(params:any):Observable<any>{
    let serviceUrl = environment.serviceURL+'getSubsidydetail';
    let serviceRes = this.Http.post(serviceUrl,params);
    return serviceRes;
  }
}
