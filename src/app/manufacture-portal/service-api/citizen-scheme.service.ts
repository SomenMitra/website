...
// get application track status
  ...
  // get pre-verification document list
  getVerificationDocList(params: any): Observable<any> {
    let serviceUrl = environment.servicePMKSYURL + 'getVerificationDocList';
    let serviceRes = this.Http.post(serviceUrl, params);
    return serviceRes;
  }
  // get Deviation Details
  getDeviationDetails(params: any): Observable<any> {
    let serviceUrl = environment.servicePMKSYURL + 'getDeviationDetails';
    let serviceRes = this.Http.post(serviceUrl, params);
    return serviceRes;
  }
}
